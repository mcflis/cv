...
Division "Technology" responsible for the implementation of Set-Top-Box (STB) applications
  ...
  - **_Master's Thesis:_** conceptualised and implemented a machine learning powered tool to support identifying duplicate defect reports in Jira 
...
- **_Bachelor's Thesis:_** conceptualised and implemented an Android app for Google Glass to support operators at SMT assembly production lines
